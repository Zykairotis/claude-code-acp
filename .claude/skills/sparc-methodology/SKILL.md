...
# Run with options
claude-flow sparc run <mode> "task" --parallel --monitor
...
claude-flow sparc run researcher "authentication patterns"

# Step 2: Architecture design
claude-flow sparc run architect "design auth system"

# Step 3: TDD implementation
claude-flow sparc tdd "user authentication feature"

# Step 4: Code review
claude-flow sparc run reviewer "review auth implementation"

# Step 5: Documentation
claude-flow sparc run documenter "document auth API"
```
...
claude-flow sparc run analyzer "investigate bug #456"

# Step 2: Debug systematically
claude-flow sparc run debugger "fix memory leak in service X"

# Step 3: Create tests
claude-flow sparc run tester "regression tests for bug #456"

# Step 4: Review fix
claude-flow sparc run reviewer "validate bug fix"
```
...
claude-flow sparc run analyzer "profile API response times"

# Step 2: Identify bottlenecks
claude-flow sparc run optimizer "optimize database queries"

# Step 3: Implement improvements
claude-flow sparc run coder "implement caching layer"

# Step 4: Benchmark results
claude-flow sparc run tester "performance benchmarks"
```
...
claude-flow sparc pipeline "e-commerce checkout feature"
