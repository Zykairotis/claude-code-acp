...
claude-flow sparc run spec-pseudocode "OAuth2 authentication system"
claude-flow sparc run architect "microservices communication layer"
claude-flow sparc tdd "payment processing feature"
claude-flow sparc pipeline "complete feature implementation"

# Batch processing for complex goals
claude-flow sparc batch spec,arch,refine "user management system"
claude-flow sparc concurrent tdd tasks.json
```
...
sparc_phases:
  specification:
    command: "claude-flow sparc run spec-pseudocode 'payment processing'"
    deliverables:
      - requirements_doc
      - acceptance_criteria
      - test_scenarios
  ...
  pseudocode:
    command: "claude-flow sparc run pseudocode 'payment flow algorithms'"
    deliverables:
      - payment_flow_logic
  ...
  architecture:
    command: "claude-flow sparc run architect 'payment system design'"
    deliverables:
      - system_components
      - api_contracts
      - database_schema
  ...
  refinement:
    command: "claude-flow sparc tdd 'payment feature'"
    deliverables:
      - unit_tests
      - integration_tests
  ...
  completion:
    command: "claude-flow sparc run integration 'deploy payment system'"
    deliverables:
      - deployed_system
      - documentation
      - monitoring_setup
...
claude-flow sparc run spec-pseudocode "user authentication feature"

# 2. Execute architecture phase
claude-flow sparc run architect "authentication system design"

# 3. TDD implementation with goal tracking
claude-flow sparc tdd "authentication feature" --track-goals

# 4. Complete integration with goal validation
claude-flow sparc run integration "deploy authentication" --validate-goals

# 5. Verify goal achievement
claude-flow sparc verify "authentication feature complete"
```
