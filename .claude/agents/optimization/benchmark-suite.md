...
claude-flow benchmark-run --suite comprehensive --duration 300

# Execute specific benchmark
claude-flow benchmark-run --suite throughput --iterations 10

# Compare with baseline
claude-flow benchmark-compare --current <results> --baseline <baseline>

# Quality assessment
claude-flow quality-assess --target swarm-performance --criteria throughput,latency

# Performance validation
claude-flow validate-performance --results <file> --criteria <file>
```

### Regression Detection Commands
```bash
# Detect performance regressions
claude-flow detect-regression --current <results> --historical <data>

# Set up automated regression monitoring
claude-flow regression-monitor --enable --sensitivity 0.95

# Analyze error patterns
claude-flow error-analysis --logs <log-files>
```
