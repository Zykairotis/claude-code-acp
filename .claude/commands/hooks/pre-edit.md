...
```bash
claude-flow hook pre-edit -f "config/database.js" --validate-syntax
```

### Manual agent assignment

```bash
claude-flow hook pre-edit -f "api/users.ts" --auto-assign-agent false
```
...
claude-flow hook pre-edit --file "path/to/file.js" --validate-syntax
```
