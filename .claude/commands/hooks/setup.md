...
```bash
# Test pre-edit hook
claude-flow hook pre-edit --file test.js

# Test session summary
claude-flow hook session-end --summary
```
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [{
          "type": "command",
          "command": "claude-flow hook pre-write --file '${tool.params.file_path}'"
        }]
      }
    ]
  }
...
# Test specific hook
claude-flow hook pre-edit --file app.js --debug
```
