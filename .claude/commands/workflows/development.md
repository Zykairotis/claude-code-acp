...
claude-flow workflow dev "REST API with auth"

# Create custom workflow
claude-flow workflow create --name "api-dev" --steps "design,implement,test,deploy"

# Execute saved workflow
claude-flow workflow execute api-dev
```